...
export default function ProductsLoudingScreen({ count }: countProp) {
    let arr: number[] = []
  ...
  return (
      <div className="grid md:grid-cols-3 lg:grid-cols-5 gap-8 p-4">
        {arr.map((_, ind) => (<div key={ind} role="status" className="   p-4 border border-gray-200 rounded-sm shadow-sm animate-pulse md:p-6 dark:border-gray-700">
