...
export default function BrandProduct(props : catergoryOrbrand) {
  return (
    <Link to={`/brands/${props._id}`} className='bg-white border group cursor-pointer border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700'>
